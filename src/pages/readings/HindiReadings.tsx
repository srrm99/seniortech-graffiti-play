...
const readingTypes: ReadingType[] = [
  {
    ...
    prompt: 'हिंदी में एक छोटा धार्मिक पाठ लिखें (2 पैराग्राफ) जो आस्था और आशा के बारे में हो। अंत में एक छोटा चिंतन प्रश्न जोड़ें।'
  },
  {
    id: 'motivational',
    title: 'प्रेरणादायक',
    description: 'प्रेरित करने वाली कहानियां और विचार',
    prompt: 'हिंदी में एक छोटा प्रेरक संदेश लिखें (2-3 पैराग्राफ) जो सकारात्मक रहने का संदेश दे। एक व्यावहारिक सुझाव भी शामिल करें।'
  },
  {
    id: 'story',
    title: 'कहानी',
    description: 'सार्थक लघु कथाएं',
    prompt: 'हिंदी में एक बहुत छोटी कहानी लिखें (अधिकतम 2 पैराग्राफ) जिसमें एक स्पष्ट नैतिक सीख हो। पारिवारिक मूल्यों या दया पर ध्यान दें।'
  },
  {
    id: 'wisdom',
    title: 'दैनिक ज्ञान',
    description: 'दैनिक जीवन के लिए व्यावहारिक ज्ञान',
    prompt: 'हिंदी में एक व्यावहारिक ज्ञान का टुकड़ा साझा करें (1-2 पैराग्राफ) जो पारंपरिक मूल्यों से प्रेरित हो। इसे संक्षिप्त और क्रियान्वयन योग्य रखें।'
  }
];
