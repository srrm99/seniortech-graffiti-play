...
const HindiInfoAssistant = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('https://api.perplexity.ai/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'You are a helpful assistant for senior citizens. Be respectful, patient, and clear in your responses. Format your responses in markdown for better readability. Respond in Hindi with proper grammar and natural conversational style.'
            },
            ...messages.map(msg => ({
              role: msg.role,
              content: msg.content
      ...
      toast({
        title: "त्रुटि",
        description: "जवाब प्राप्त करने में विफल। कृपया पुनः प्रयास करें।",
        variant: "destructive",
      });
    }
    setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-background p-6 space-y-8">
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-3xl font-rozha text-accent">जानकारी सहायक</h1>
        <div className="w-10" />
      </div>
...
export default HindiInfoAssistant;
